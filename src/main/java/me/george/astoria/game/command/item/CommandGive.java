...
public class CommandGive extends BaseCommand {
    ...
    public CommandGive() {
        super("give", Arrays.asList(Requirement.ADMIN), "/give <item> or /give <item> <amount> or /give <player> <item> <amount> (optional)", "Gives yourself or a player an item of a specific amount.");
    }
